...
function getCardDesign(entryType, epoch) {
    if (entryType === "RE")
      ...
      return {icon:"2.png", bg:'repeating-linear-gradient(-30deg, rgba(100, 100, 100, 0.2), rgba(100, 100, 100, 0.2) 3px, rgba(40,44,52,0.5) 2px, rgba(40,44,52,0.5) 10px)', link:"https://knowyourmeme.com/", date:formatDateFromEpoch(epoch, entryType), borderRadius:"50%"}
}
